...
const ReviewStep: React.FC<ReviewStepProps> = ({
  ...
  const mockEventData: Event = {
    ...
    description: 'Sịnh nhật',
    start_time: '2025-08-13T03:00:00.000Z',
    end_time: '2025-08-13T09:00:00.000Z',
    event_date: '2025-08-13T00:00:00.000Z',
    estimated_cost: '1000000',
    final_cost: null,
    room_service_fee: null,
    date_create: '2025-08-10T01:12:12.632Z',
    updated_at: '2025-08-10T01:12:12.691Z',
    status: 'PENDING',
    account_id: 1,
    room_id: 1,
    event_type_id: 3,
    account: {
      account_id: 1,
      account_name: 'admin',
      email: 'admin@gazer.com',
      phone: '0987654321',
    },
    room: {
      room_id: 1,
      room_name: 'Phòng tiệc nhỏ',
      is_active: true,
    },
    event_type: {
      type_id: 3,
      type_name: 'Birthday Party',
      is_active: true,
    },
    event_services: [
      {
        ...
        service: {
          service_id: 1,
          service_name: 'Tiệc cưới đơn giản',
          description:
            'Dịch vụ tiệc cưới đơn giản, đi kèm setup theo yêu cầu và MC tiệc cưới',
          is_active: true,
        },
        variation: {
          variation_id: 1,
          variation_name: 'MC tiệc cưới chuyên nghiệp',
          base_price: '500000',
          duration_hours: 2,
          is_active: true,
        },
