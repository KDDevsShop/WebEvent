    ...
    <section className='relative bg-tertiary py-16 px-6 overflow-hidden mt-12'>
      ...
      <div className='container mx-auto relative z-10'>
        <div className='flex flex-col lg:flex-row items-center justify-between gap-8'>
          ...
          <div className='flex-shrink-0'>
            <Button className='bg-primary text-tertiary px-8 py-4 rounded-lg hover:bg-secondary transition-all duration-300 font-semibold text-lg flex items-center gap-3 shadow-lg hover:shadow-xl transform hover:scale-105'>
              <Calendar size={24} />
              Tạo sự kiện
            </Button>
          </div>
